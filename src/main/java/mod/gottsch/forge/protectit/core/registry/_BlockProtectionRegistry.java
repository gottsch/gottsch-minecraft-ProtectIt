 ...
 */
@Deprecated
public class _BlockProtectionRegistry {
//
//	// legacy key/value
...
//
//	// TODO these four maps should be wrapped in CRUD operations together and all modifications (deed, lease, renamed) must go thru the crud.
//	
//	/*
...
//		}
//
//		property.setFiefdom(subdivisible);
//		return true;
//	}
//
//	/**
...
//	 */
//	@Deprecated
//	public List<Interval> addWhitelist(ICoords coords1, ICoords coords2, PlayerIdentity owner, PlayerIdentity data) {
...
//		properties.forEach(p -> {
//			try {
//				if (p.getLord() == null || p.getLord().equals(Property.EMPTY)) {
//					PROPERTY_BY_COORDS.remove(p.getCoords());
//				} else {
//					PROPERTY_BY_LANDLORD.get(UUID.fromString(p.getLord().getUuid())).remove(p);
//				}
...
//			ProtectIt.LOGGER.debug("isProtectedAgainst parent -> {}", property);
...
//				}
//			}
//			ProtectIt.LOGGER.debug("isProtectedAgainst property -> {}", property);
...
//					(property.getOwner().equals(PlayerIdentity.EMPTY) && property.getLord().getUuid().equalsIgnoreCase(uuid)) ) {
//				//				break;
//				return false;
//			}
//			// this is deprecated to the above statement
